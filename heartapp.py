...
# Add the description
st.markdown("Heart disease is a major cause of death around the world, but finding it early can save lives. This app helps you check your risk based on your health information,")
st.markdown("so you can take steps to stay healthy.")
st.markdown("It's easy to use, keeps your data safe, and gives you the information you need to make good choices about your heart health. Before that, please have a look at the symptoms of heart diseases.")
